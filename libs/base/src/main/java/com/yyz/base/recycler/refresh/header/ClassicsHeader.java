package com.yyz.base.recycler.refresh.header;
...
import com.yyz.base.recycler.refresh.internal.ProgressDrawable;
import com.yyz.base.recycler.refresh.internal.pathview.PathsDrawable;
...
public class ClassicsHeader extends RelativeLayout implements RefreshHeader {
    ...
    public static String REFRESH_HEADER_PULL_DOWN = "下拉可以刷新";
    public static String REFRESH_HEADER_REFRESHING = "正在刷新...";
    public static String REFRESH_HEADER_LOADING = "";     //加载更多时候，布局拉到头位置显示文案，现去除文字  <正在加载...>
    public static String REFRESH_HEADER_RELEASE = "释放立即刷新";
    public static String REFRESH_HEADER_FINISH = "刷新完成";
    public static String REFRESH_HEADER_FAILED = "刷新失败";
    public static String REFRESH_HEADER_LAST_TIME = "上次更新 M-d HH:mm";
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mTitleText.setText(REFRESH_HEADER_PULL_DOWN);

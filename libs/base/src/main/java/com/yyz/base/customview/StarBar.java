...
/**
 * Created by lifengmei on 2017/10/20.
 * <p>
 * 自定义星级评分标准--使用RatingBar或者自己绘制
 * 1，可以自选星星图片,设置总共几颗星，评价几颗星，星星的样式
 * 2，可点击可触摸选择星星--可控制是否可点击选择
 * 3，可以半星或者整星或者零点几倍率的选则分数
 * 4，点击事件向外暴露--得知用户选择了几星，便于显示不同的标签啊，记录星级的选择啊等等
 */
...
public class StarBar extends View {
    ...
    private boolean integerMark = false;//是否按照整数评分
    private boolean isIndicator = false;//是否是固定的
     ...
     * 设置是否固定不变
     *
     * @param isIndicator true表示是锚点不能触摸选择
     */
...
//                    setStarMark(x*1.0f / (getMeasuredWidth()*1.0f/starCount));   不用滑动关闭
                    break;
                }

package com.yyz.base.recycler.refresh;
...
import com.yyz.base.recycler.refresh.api.DefaultRefreshFooterCreater;
import com.yyz.base.recycler.refresh.api.DefaultRefreshHeaderCreater;
import com.yyz.base.recycler.refresh.api.RefreshContent;
...
import com.yyz.base.recycler.refresh.constant.DimensionStatus;
import com.yyz.base.recycler.refresh.constant.RefreshState;
import com.yyz.base.recycler.refresh.constant.SpinnerStyle;
import com.yyz.base.recycler.refresh.footer.ClassicsFooter;
import com.yyz.base.recycler.refresh.header.ClassicsHeader;
import com.yyz.base.recycler.refresh.impl.RefreshContentWrapper;
import com.yyz.base.recycler.refresh.impl.RefreshFooterWrapper;
import com.yyz.base.recycler.refresh.impl.RefreshHeaderWrapper;
...
import com.yyz.base.recycler.refresh.util.DelayedRunnable;
import com.yyz.base.recycler.refresh.util.DensityUtil;
import com.yyz.base.recycler.refresh.util.ViscousFluidInterpolator;
...
public class RefreshLayout extends ViewGroup implements RefreshLayoutImpl, NestedScrollingParent, NestedScrollingChild {
    ...
    protected static DefaultRefreshFooterCreater sFooterCreater = new DefaultRefreshFooterCreater() {
        @NonNull
        @Override
        public RefreshFooter createRefreshFooter(Context context, RefreshLayoutImpl layout) {
    ...
    protected static DefaultRefreshHeaderCreater sHeaderCreater = new DefaultRefreshHeaderCreater() {
        @NonNull
        @Override
        public RefreshHeader createRefreshHeader(Context context, RefreshLayoutImpl layout) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.refreshLayout_srlHeaderHeight, density.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.refreshLayout_srlFooterHeight, density.dip2px(60));
    ...
    protected void onAttachedToWindow() {
        ...
        if (mDelayedRunnables != null) {
            for (DelayedRunnable runnable : mDelayedRunnables) {
                handler.postDelayed(runnable, runnable.delayMillis);
            }
        ...
        if (mRefreshFooter == null) {
            if (mEnablePureScrollMode) {
                mRefreshFooter = new RefreshFooterWrapper(new ClassicsFooter(getContext()));
                mEnableLoadMore = mEnableLoadMore || !mManualLoadMore;
            } else {
        ...
        if (mRefreshListener == null) {
            mRefreshListener = new OnRefreshListener() {
                @Override
                public void onRefresh(RefreshLayoutImpl refreshlayoutImpl) {
                    refreshlayoutImpl.finishRefresh(3000);
                }
            };
        }
        if (mLoadMoreListener == null) {
            mLoadMoreListener = new OnLoadMoreListener() {
                @Override
                public void onLoadMore(RefreshLayoutImpl refreshlayoutImpl) {
                    refreshlayoutImpl.finishLoadMore(2000);
                }
            };
        }
        if (mPrimaryColors != null) {
...
//        mRefreshContent = null;
    ...
    protected void setStateLoadingFinish() {
        notifyStateChanged(RefreshState.LoadFinish);
    }

    protected void setStateRefreshingFinish() {
...
//            setStatePullUpCanceled();这块改了，这样就没有越界回弹了
            setStateLoading();
...
//        }
    ...
    @Override
    public RefreshLayout setFooterHeightPx(int heightPx) {
    ...
    @Override
    public RefreshLayout setHeaderHeightPx(int heightPx) {
     ...
     */
    @Override
    public RefreshLayout setEnableLoadMore(boolean enable) {
     ...
     */
    @Override
    public RefreshLayout setEnableRefresh(boolean enable) {
     ...
     */
    @Override
    public RefreshLayout setEnableHeaderTranslationContent(boolean enable) {
     ...
     */
    @Override
    public RefreshLayout setEnableFooterTranslationContent(boolean enable) {
     ...
     */
    @Override
    public RefreshLayout setEnableAutoLoadMore(boolean enable) {
     ...
     */
    @Override
    public RefreshLayout setEnableOverScrollBounce(boolean enable) {
     ...
     */
    @Override
    public RefreshLayout setEnablePureScrollMode(boolean enable) {
     ...
     */
    @Override
    public RefreshLayout setEnableScrollContentWhenLoaded(boolean enable) {
     ...
     */
    @Override
    public RefreshLayout setEnableLoadMoreWhenContentNotFull(boolean enable) {
     ...
     */
    @Override
    public RefreshLayout setPrimaryColors(int... colors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public RefreshLayout finishLoadMore(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading) {
                    if (mRefreshFooter != null && mKernel != null && mRefreshContent != null) {
                        int startDelay = mRefreshFooter.onFinish(RefreshLayout.this, success);
                        if (startDelay == Integer.MAX_VALUE) {
                            return;
                        }
                        notifyStateChanged(RefreshState.LoadFinish);
    ...
    protected class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshContent getRefreshContent() {
            return RefreshLayout.this.mRefreshContent;
        }

        //<editor-fold desc="状态更改 state changes">
        public RefreshKernel setStatePullUpToLoad() {
            RefreshLayout.this.setStatePullUpToLoad();
            return this;
        }

        public RefreshKernel setStateReleaseToLoad() {
            RefreshLayout.this.setStateReleaseToLoad();
            return this;
        }

        public RefreshKernel setStateReleaseToRefresh() {
            RefreshLayout.this.setStateReleaseToRefresh();
            return this;
        }

        public RefreshKernel setStatePullDownToRefresh() {
            RefreshLayout.this.setStatePullDownToRefresh();
            return this;
        }

        public RefreshKernel setStatePullDownCanceled() {
            RefreshLayout.this.setStatePullDownCanceled();
            return this;
        }

        public RefreshKernel setStatePullUpCanceled() {
            RefreshLayout.this.setStatePullUpCanceled();
            return this;
        }

        public RefreshKernel setStateLoading() {
            RefreshLayout.this.setStateLoading();
            return this;
        }

        public RefreshKernel setStateRefreshing() {
            RefreshLayout.this.setStateRefreshing();
            return this;
        }

        @Override
        public RefreshKernel setStateLoadingFinish() {
            RefreshLayout.this.setStateLoadingFinish();
            return this;
        }

        @Override
        public RefreshKernel setStateRefreshingFinish() {
            RefreshLayout.this.setStateRefreshingFinish();
            return this;
        }

        public RefreshKernel resetStatus() {
            RefreshLayout.this.resetStatus();
            return this;
        }
        //</editor-fold>
        ...
        public RefreshKernel moveSpinnerInfinitely(float dy) {
            RefreshLayout.this.moveSpinnerInfinitely(dy);
            return this;
        }

        public RefreshKernel moveSpinner(int spinner, boolean isAnimator) {
            RefreshLayout.this.moveSpinner(spinner, isAnimator);
            return this;
        }

        public RefreshKernel animSpinner(int endSpinner) {
            RefreshLayout.this.animSpinner(endSpinner);
            return this;
        }

        @Override
        public RefreshKernel animSpinnerBounce(int bounceSpinner) {
            RefreshLayout.this.animSpinnerBounce(bounceSpinner);
            return this;
        }
    ...
    public boolean post(Runnable action) {
        ...
        return handler.post(new DelayedRunnable(action));
    }
    ...
    public boolean postDelayed(Runnable action, long delayMillis) {
        ...
        return handler.postDelayed(new DelayedRunnable(action), delayMillis);
    }

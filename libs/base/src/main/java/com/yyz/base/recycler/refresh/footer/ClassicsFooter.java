...
public class ClassicsFooter extends RelativeLayout implements RefreshFooter {
    ...
    public static String REFRESH_FOOTER_LOADING = "正在加载更多...";
    public static String REFRESH_FOOTER_REFRESHING = "";     //刷新时，底部布局显示文字，先去除文字，显示白色底。<正在刷新...>
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTitleText.setText(REFRESH_FOOTER_PULL_UP);
    ...
    public boolean setLoadMoreFinished(boolean finished) {
        if (mLoadMoreFinished != finished) {
            ...
            if (finished) {
                mTitleText.setText(REFRESH_FOOTER_ALL_LOADED);
            } else {
                mTitleText.setText(REFRESH_FOOTER_PULL_UP);
            }
            if (mProgressDrawable != null) {

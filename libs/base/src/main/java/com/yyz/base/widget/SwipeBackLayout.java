...
public class SwipeBackLayout extends FrameLayout {
     ...
     * @param ac
     */
    public void attachToActivity(Activity ac) {
        mAc = ac;
        TypedArray a = ac.getTheme().obtainStyledAttributes(
                new int[]{android.R.attr.windowBackground});
        int background = a.getResourceId(0, 0);
        a.recycle();

        ViewGroup decor = (ViewGroup) ac.getWindow().getDecorView();
    ...
    /**
     * 添加 ViewPager 用于处理ViewPager 和SwipeBack 事件冲突
     *
     * @param viewPager
     */

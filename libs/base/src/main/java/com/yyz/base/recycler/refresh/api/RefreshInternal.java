...
import com.yyz.base.recycler.refresh.interfaces.OnStateChangedListener;
...
public interface RefreshInternal extends OnStateChangedListener {
     ...
     * @param extendHeight extendHeaderHeight or extendFooterHeight
     */
    void onStartAnimator(RefreshLayoutImpl layout, int height, int extendHeight);
     ...
     */
    int onFinish(RefreshLayoutImpl layout, boolean success);
